...
namespace VideoSystemFeature
{
	...
	{
		NO_FEATURES					= 1 << 0,
		PLAY_VIDEO_FILE_FULL_SCREEN = 1 << 1,
		PLAY_VIDEO_FILE_IN_MATERIAL = 1 << 2,
		ENCODE_VIDEO_TO_FILE		= 1 << 3,
		ENCODE_AUDIO_TO_FILE		= 1 << 4,
...
{
	enum EVideoPlaybackFlags_t
	{
		NO_PLAYBACK_OPTIONS = 0,

		// Full Screen Playback Options
		FILL_WINDOW					= 1 << 0,
		LOCK_ASPECT_RATIO			= 1 << 1,
		INTEGRAL_SCALE				= 1 << 2,
		CENTER_VIDEO_IN_WINDOW		= 1 << 3,

		FORCE_MIN_PLAY_TIME			= 1 << 4,

		ABORT_ON_SPACE				= 1 << 8,
		ABORT_ON_ESC				= 1 << 9,
		ABORT_ON_RETURN				= 1 << 10,
		ABORT_ON_ANY_KEY			= ABORT_ON_SPACE | ABORT_ON_ESC | ABORT_ON_RETURN,

		PAUSE_ON_SPACE				= 1 << 12,
		PAUSE_ON_ESC				= 1 << 13,
		PAUSE_ON_RETURN				= 1 << 14,
		PAUSE_ON_ANY_KEY			= PAUSE_ON_SPACE | PAUSE_ON_ESC | PAUSE_ON_RETURN,

		LOOP_VIDEO					= 1 << 16,
		NO_AUDIO					= 1 << 17,
		PRELOAD_VIDEO				= 1 << 18,

		DONT_AUTO_START_VIDEO		= 1 << 20,
		TEXTURES_ACTUAL_SIZE		= 1 << 21,

		VALID_FULLSCREEN_FLAGS		= FILL_WINDOW | LOCK_ASPECT_RATIO | INTEGRAL_SCALE | CENTER_VIDEO_IN_WINDOW | FORCE_MIN_PLAY_TIME | ABORT_ON_ANY_KEY | PAUSE_ON_ANY_KEY,
		VALID_MATERIAL_FLAGS		= LOOP_VIDEO | NO_AUDIO | PRELOAD_VIDEO | DONT_AUTO_START_VIDEO | TEXTURES_ACTUAL_SIZE,
