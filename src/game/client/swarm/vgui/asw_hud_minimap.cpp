...
ConVar asw_blip_color_parasite_defanged( "asw_blip_color_parasite_defanged", "255 0 13", FCVAR_NONE, "The parasite defanged blip color. Detection method requires correct parasite model" );
