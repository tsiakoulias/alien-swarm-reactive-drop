...
GameRulesConVarSkill( s_ASWMarineSkillsConVars, AMSC_HEALING_AMP_GUN_CHARGES, asw_skill_healing_amp_gun_charges, 15, 10, "", ASW_MARINE_SKILL_HEALING, ASW_MARINE_SUBSKILL_HEALAMP_GUN_CHARGES );
