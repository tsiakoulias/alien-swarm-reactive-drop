...
VMFs = [
##		MapInfo("asi-jac1-landingbay_01", "3000", "0", postcompiler=False),
##		MapInfo("asi-jac1-landingbay_02", "2500", "0", postcompiler=False),
##		MapInfo("asi-jac1-landingbay_pract", "3000", "0", postcompiler=False),
##		MapInfo("asi-jac2-deima", "2500", "0", postcompiler=False),
##		MapInfo("asi-jac3-rydberg", "2500", "0", postcompiler=False),
##		MapInfo("asi-jac4-residential", "2500", "0", postcompiler=False),
##		MapInfo("asi-jac6-sewerjunction", "2500", "0", postcompiler=False),
##		MapInfo("asi-jac7-timorstation", "2500", "0", postcompiler=False),
##		MapInfo("example_map_1", "1500", "1"),
##		MapInfo("example_map_2", "1500", "1"),
##		MapInfo("example_map_3", "1500", "1"),
##		MapInfo("rd-bio1operationx5", "750", "0", postcompiler=False),
##		MapInfo("rd-bio2invisiblethreat", "750", "0", postcompiler=False),
##		MapInfo("rd-bio3biogenlabs", "750", "0", postcompiler=False),
...
##		MapInfo("rd-area9800lz", "1500", "0", postcompiler=False),
##		MapInfo("rd-area9800pp1", "1500", "0", postcompiler=False),
##		MapInfo("rd-area9800pp2", "750", "0", postcompiler=False),
##		MapInfo("rd-area9800wl", "1500", "0", postcompiler=False),
##		MapInfo("rd-bonus_mission1", "2500", "0", postcompiler=False),
##		MapInfo("rd-bonus_mission2", "2500", "0", postcompiler=False),
##		MapInfo("rd-bonus_mission3", "750", "0", postcompiler=False),
##		MapInfo("rd-bonus_mission4", "3000", "0", postcompiler=False),
##		MapInfo("rd-bonus_mission5", "750", "1"),
##		MapInfo("rd-bonus_mission6", "1500", "1"),
##		MapInfo("rd-bonus_mission7", "1500", "0", postcompiler=False),
...
##		MapInfo("rd-lan1_bridge", "2000", "0", postcompiler=False),
##		MapInfo("rd-lan2_sewer", "1500", "0", postcompiler=False),
##		MapInfo("rd-lan3_maintenance", "750", "0", postcompiler=False),
##		MapInfo("rd-lan4_vent", "2500", "0", postcompiler=False),
##		MapInfo("rd-lan5_complex", "750", "0", postcompiler=False),
##		MapInfo("rd-ocs1storagefacility", "750", "0", postcompiler=False),
##		MapInfo("rd-ocs2landingbay7", "2500", "0", postcompiler=False),
##		MapInfo("rd-ocs3uscmedusa", "750", "0", postcompiler=False),
...
##		MapInfo("rd-res1forestentrance", "750", "0", postcompiler=False),
##		MapInfo("rd-res2research7", "1500", "0", postcompiler=False),
##		MapInfo("rd-res3miningcamp", "1500", "0", postcompiler=False),
##		MapInfo("rd-res4mines", "1500", "0", postcompiler=False),
##		MapInfo("rd-tft1desertoutpost", "3000", "0", postcompiler=False),
##		MapInfo("rd-tft2abandonedmaintenance", "1500", "0", postcompiler=False),
##		MapInfo("rd-tft3spaceport", "2000", "0", postcompiler=False),
##		MapInfo("rd-til1midnightport", "1500", "0", postcompiler=False),
##		MapInfo("rd-til2roadtodawn", "750", "0", postcompiler=False),
##		MapInfo("rd-til3arcticinfiltration", "2500", "1"),
##		MapInfo("rd-til4area9800", "750", "0", postcompiler=False),
##		MapInfo("rd-til5coldcatwalks", "1500", "0", postcompiler=False),
##		MapInfo("rd-til6yanaurusmine", "750", "0", postcompiler=False),
##		MapInfo("rd-til7factory", "750", "0", postcompiler=False),
##		MapInfo("rd-til8comcenter", "1500", "0", postcompiler=False),
##		MapInfo("rd-til9syntekhospital", "750", "0", postcompiler=False),
